    ...
    <header className="h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 md:px-6 flex items-center justify-between z-30 sticky top-0 shadow-2xs">
      ...
      <div className="flex items-center gap-3 min-w-0">
        <button
          type="button"
          onClick={handleBack}
          className="p-2 rounded-xl text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition flex-shrink-0 cursor-pointer"
        ...
        <div className="min-w-0">
          ...
          {activeLesson ? (
            <p className="text-[11px] text-gray-500 dark:text-gray-400 truncate">
              <Link to={STUDENT.COURSES} className="hover:underline text-gray-400">My Courses</Link> &bull; {activeLesson.sectionTitle} &bull; <span className="text-gray-700 dark:text-gray-300 font-semibold">{activeLesson.title}</span>
            </p>
          ) : (
